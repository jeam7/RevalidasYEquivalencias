...
return [
    ...
    */
    ...
    'password_reset' => [
      ...
      'greeting' => 'Hemos recibido una solicitud de recuperación de contraseña',
      'line_1' => 'Haz click en el siguiente boton para continuar con el proceso: ',
      'line_2' => '',
      'notice' => 'En caso de desconocer esta solicitud, ignorar este correo.'
    ]
];
